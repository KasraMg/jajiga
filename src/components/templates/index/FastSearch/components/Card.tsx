...
const Card: FC<CardProps> = () => {
    return (
        <div className='relative cursor-pointer !h-[247px] sm:!h-[274px] rounded-xl text-white bg-[url(https://www.jajiga.com/static/img/home/special-filters/cottageForest.jpg?v=3)]'>
