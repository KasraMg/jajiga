  ...
  return (
    <div className="flex flex-col md:flex-row items-center justify-between becomeHostBg rounded-2xl mt-8">
      <div className="mr-4 space-y-4 w-full md:!w-1/2 my-2">
        ...
        <Button className="bg-[#404040] text-white rounded-full  px-3 text-xs block mx-auto relative top-6 md:!mt-4 !mt-0 md:!top-0 border-4 border-[#ffe666] border-solid md:!mr-0 md:!ml-auto ">
          توضیحات بیشتر
        </Button>
      </div>
