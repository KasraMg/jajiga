    ...
    <Dialog>
      ...
      {typeof window !== "undefined" && (
        <DialogContent className="w-full max-w-full sm:!max-w-[425px]">
          ...
          <div className="flex h-[38px] cursor-pointer items-center rounded-lg bg-[#5b5b5b] text-white">
            <div className="w-[38px] text-2xl">
          ...
          <Link
            ...
            className="flex h-[38px] items-center rounded-lg bg-[#2499d5] text-white"
          >
            <div className="w-[38px] text-2xl">
          ...
          <Link
            target="_blank"
            href={`sms:?&body=${window.location}`}
            className="flex h-[38px] items-center rounded-lg bg-[#f28900] text-white"
          >
            <div className="w-[38px] text-2xl">
