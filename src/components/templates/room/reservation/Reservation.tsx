...
const Reservation = () => {
    ...
    const hideReservationModal = () => setReservationModal(false);
    return (
        <>
            ...
            <div className='block md:!hidden px-5 fixed bottom-16 w-full'>
                <div className='py-3 items-center rounded-lg px-2 bg-[#00000099] w-full flex text-white justify-between'>
                    ...
                    <Button variant={'yellow'} className='rounded-full'>
                        <span onClick={() => setReservationModal(true)}>درخواست رزرو</span>
                    </Button>
                </div>
            </div>

            <Modal 
                hideHandler={hideReservationModal}
            ...
            >
                  <div className='rounded-b-2xl py-[14px] px-4'>
                    ...
                    <Link href={'/faq'}>
                        <Button className='w-full justify-center  !top-0 !left-0 !right-0 !bottom-0 !relative mt-5 border-[#00000028]' variant={"white"}>
