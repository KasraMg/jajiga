...
const Navbar = () => {
    ...
    return (
        <>
            <nav dir="ltr" style={{ animation: isSticky ? ' slideDown 0.35s ease-out' : 'none', boxShadow: isSticky ? '0 5px 16px rgba(0, 0, 0, 0.1)' : 'none' }} className={`${isSticky ? '!top-0 !fixed z-[999] left-0 w-full text-black bg-white !max-w-full' : '  z-30 absolute  right-0 left-0 Container'} `}>
                <div className={`${!isSticky ? 'py-4' : 'py-2'} Container flex justify-between xl:!px-0 px-3 lg:!px-6 gap-2 sm:!gap-2 lg:!gap-5`}>
                    <div className="relative w-[50px] xl:!w-[120px]">
                    ...
                    {isSticky && (
                        <div className="flex gap-3 sm:!w-max w-[55%]">
                            <div className='relative mx-auto  sm:!w-max w-full'>
                                <i className=' absolute cursor-pointer top-[4.3px] left-1 py-2 rounded-full px-2 text-[1.2rem] text-black'>
                                    <CiSearch />
                                </i>
                                <input style={{ boxShadow: 'none' }} dir='rtl' type="text" className=' border-[#0000005c] rounded-full placeholder:text-gray-300 focus:!border-[#6B7280] w-full sm:!w-[170px] lg:!w-[363px]' placeholder='میخوای کجا بری؟' />
                            </div>
                            <div className="border border-[#0000003c] sm:!block hidden border-solid rounded-full p-1">
                    ...
                    <section className='flex items-center gap-8'>
                        <ul className={` ${isSticky ? 'text-black' : 'text-white'} hidden sm:!flex gap-8 font-vazir-medium flex-row-reverse`}>
                            {/* 
                        <li>اعلانات</li>
                        <li>رزرو ها</li>
                        <li>اقامتگاه ها</li>
