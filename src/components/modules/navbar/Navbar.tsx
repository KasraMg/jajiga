        ...
        <nav dir="ltr" style={{ animation: isSticky ? ' slideDown 0.35s ease-out' : 'none', boxShadow: isSticky ? '0 5px 16px rgba(0, 0, 0, 0.1)' : 'none' }} className={`${isSticky ? '!top-0 !fixed z-[999] left-0 w-full text-black bg-white !max-w-full' : '  z-30 absolute  right-0 left-0 container'} `}>
            <div className={`${!isSticky ? 'py-4' : 'py-2'} container flex justify-between  gap-5`}>
                ...
                {isSticky && (
                    <div className="flex gap-3">
                        <div className='relative w-max mx-auto'>
                            ...
                            <input style={{ boxShadow: 'none' }} dir='rtl' type="text" className='rounded-full placeholder:text-gray-300 focus:!border-[#6B7280] w-[363px]' placeholder='میخوای کجا بری؟' />
                        </div>
                        <div className="border border-[#0000003c] border-solid rounded-full p-1">
                ...
                <section className='flex items-center gap-8'>
                    <ul className={` ${isSticky ? 'text-black' : 'text-white'}  flex gap-8 font-vazir-medium flex-row-reverse`}>
                        {/* 
                        <li>اعلانات</li>
                        <li>رزرو ها</li>
                        <li>اقامتگاه ها</li>
                    */}
                    ...
                    <div className={` ${isSticky && 'border border-solid'} flex gap-2 bg-[#ffffff54] items-center pr-3 pl-2 p-1 rounded-full text-3xl`}>
