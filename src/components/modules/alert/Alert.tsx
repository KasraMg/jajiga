    ...
    return (
        ...
        className={cn(alertVariants({ variant, className }))}> 
            ...
            <div>
                ...
                <p className="leading-6 font-vazir-light my-2">لوکیشن ثبت شده برای مسیریابی به مهمانان ارسال می‌شود. طبق ضمانت تحویل جاجیگا، هرگونه مغایرت می‌تواند باعث لغو رزرو و عودت وجه به مهمان شود.</p>
            </div>
        </div>
    )
}
