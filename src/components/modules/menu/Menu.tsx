      ...
      <SheetTrigger asChild>
        <Button>
          ...
          >
            ...
            <RxHamburgerMenu className=" text-xl cursor-pointer text-black" />
          </div>
        </Button>
      </SheetTrigger>
      <SheetContent dir="ltr" className={`rounded-l-2xl py-7 right-0 fixed z-[9999] top-0 border-r h-screen overflow-y-auto transition-transform  bg-white w-72 dark:bg-gray-800`}>
        <SheetHeader> 
        ...
        <div className="absolute flex-row-reverse bottom-0 flex justify-around px-2 w-full py-3 text-xl left-0 bg-[#c1c1c175] rounded-t-3xl">
