...
export const buttonVariants = cva(
  "active:scale-95 whitespace-nowrap w-fit inline-flex items-center justify-center rounded-xl text-sm font-medium transition-color focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 disabled:opacity-50 disabled:pointer-events-none",
  {
    variants: {
      variant: {
        ...
        outlineMain:
          "bg-transparent border-1 border-main text-main hover:text-dark hover:bg-main focus:bg-transparent",
