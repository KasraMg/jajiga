...
import { ScrollContext } from "@/src/providers/scroll-observer";
...
const Intro = () => {
  ...
  return (
    <div
      ...
      ref={refContainer}
      dir="ltr"
      className={`${typeof window !== "undefined" && window.pageYOffset > 800 && "invisible"} sticky left-0 top-0 z-0 h-[60vh] w-full bg-[url(/images/1320095.jpg)] bg-cover bg-fixed bg-no-repeat lg:!h-[90vh]`}
    >
