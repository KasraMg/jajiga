...
const page = () => {
    ...
    const [communicationModal, setCommunicationModal] = useState<boolean>(false);
    ...
    return (
        <>
            ...
            <Layout>
                <div className='lg:!max-w-[815px] lg:!flex-row flex-col w-full pt-10 mx-auto gap-4 flex'>
                    <div className='lg:!w-1/2 w-full'>
                        ...
                        <div className='flex mt-4 gap-2'>
                            <div onClick={() => setCallModal(true)} style={{ boxShadow: 'rgba(0, 0, 0, 0) 0px 0px 0px 0px, rgba(0, 0, 0, 0) 0px 0px 0px 0px, rgba(0, 0, 0, 0.1) 0px 1px 3px 0px, rgba(0, 0, 0, 0.06) 0px 1px 2px 0px' }} className='w-1/2 p-2 text-center rounded-md pb-2 cursor-pointer'>
                            ...
                            <div onClick={() => setCommunicationModal(true)} style={{ boxShadow: 'rgba(0, 0, 0, 0) 0px 0px 0px 0px, rgba(0, 0, 0, 0) 0px 0px 0px 0px, rgba(0, 0, 0, 0.1) 0px 1px 3px 0px, rgba(0, 0, 0, 0.06) 0px 1px 2px 0px' }} className='w-1/2 p-2 text-center rounded-md pb-2 cursor-pointer'>
                ...
                <Modal title='تماس با پشتیبانی' hideHandler={hideCallModal} show={callModal}>
                    <>
                        <p className='text-sm text-center leading-7 text-[#404040] font-vazir-light'>ساعات کار پشتیبانی تلفنی از<strong> 8 صبح</strong> الی <strong>12 شب</strong> می‌باشد.   شماره تماس: </p>
                ...
                <Modal title='سایر راه های ارتباطی' hideHandler={hideCommunicationModal} show={communicationModal}>
                    <>
                        <p className='text-sm text-center leading-7 text-[#404040] font-vazir-light'>ساعات کار پشتیبانی تلفنی از<strong> 8 صبح</strong> الی <strong>12 شب</strong> می‌باشد.   شماره تماس: </p>
